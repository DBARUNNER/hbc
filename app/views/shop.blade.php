	...
	<li class="active">
	<a href="#shopRegister" data-toggle="tab">ثبت دوکان جــــــــدیــــــد</a>
	</li>
	<li >
	<a href="#shopTenant" data-toggle="tab">ثبت کــرایـه نــشـیــن جــــــــدیــــــد</a>
	</li>
	<li >
	<a href="#shopSold" data-toggle="tab">فروش دوکــان</a>
	</li>

	<li class="dropdown">
	<a href="#" id="shopPayment" class="dropdown-toggle" data-toggle="dropdown">پرداخت دوکان ها<b class="caret"></b>
	</a>
	<ul class="dropdown-menu" role="menu" aria-labelledby="shopPayment">
	...
	<li class="dropdown">
	<a href="#" id="shopList" class="dropdown-toggle" data-toggle="dropdown">لــیـســت دوکـــــان ها<b class="caret"></b>
	</a>
	<ul class="dropdown-menu" role="menu" aria-labelledby="shopList">
	...
	<strong style="font-size: 20px;">خطا !</strong><span style="font-size: 13px;"> {{ Session::get('error') }} </span>
	</div>
	</div>
	...
	<strong style="font-size: 20px;">موفقیت !</strong><span style="font-size: 13px;"> {{ Session::get('success') }} </span>
	</div>
	</div>
	...
	<!-- BEGIN FORM-->
	<form action="{{ URL::route('register-shop-post')}}" method="post" id="shopRegisteration" class="form-horizontal">
	<div class="form-body">
	...
	* </span>
	...
	<div class="form-group">
	<label class="control-label col-md-2">مــوقــعـیت دوکـــــان<span class="required">*</span></label>
	<div class="col-md-4">
	<div class="input-icon right">
	<i class="fa"></i>
	<input type="text" placeholder="مــوقــعـیت دوکـــــان در طــبــقــه" class="form-control" name="shopLocation"/>
	</div>
	</div>
	</div>
	<div class="form-group">
	...
	* </span>
	...
	<div class="input-icon right">
	<i class="fa"></i>
	<input type="text" placeholder="کــــــــــرایــــــــــه دوکـــــان" class="form-control" name="shopRent"/>
	</div>
	</div>
	</div>
	<div class="form-group">
	...
	* </span>
	...
	<div class="input-icon right">
	<i class="fa"></i>
	<input type="text" placeholder="مــبــلـغ پــیــش پــــــــرداخـــــــــــــت" class="form-control" name="shopPrepay"/>
	</div>
	</div>
	</div>
	...
	<div class="portlet-title">
	<div class="caption">
	<i ></i>ثـــبــت کـــرایـــــــه نــشــین 
	</div>
	<div class="tools">
	<a href="javascript:;" class="collapse">
	</a>
	...
	<div class="portlet-body form">
	<!-- BEGIN FORM-->
	<form action="{{ URL::route('') }}" method="post" id="tenantRegister" class="form-horizontal">
	<div class="form-body">
	<div class="alert alert-danger display-hide">
	<button class="close" data-close="alert"></button>
	فــارم به صــورت درســت تـــکــمــیل نــگــردیده اســــــت.
	...
	* </span></label>
	...
	<h3>مــشــخــصــات دوکـــــان کــــرایــــــه گــرفـــته شـــــــــــــــــده</h3>
	<hr>
	<div class="row">
	<div class="col-md-4">
	<div class="form-group">
	...
	<div class="portlet-body form">
	<!-- BEGIN FORM-->
	<form action="#" id="shopSales" class="form-horizontal">
	<div class="form-body">
	<div class="alert alert-danger display-hide">
	<button class="close" data-close="alert"></button>
	فــارم به صــورت درســت تـــکــمــیل نــگــردیده اســــــت.
	...
	<h3>مشخصات دوکـــــان</h3><hr class="style18">

	<div class="row">
	<div class="col-md-6">
	<div class="form-group">
	<label class="control-label col-md-3">نــمــبر دوکـــان<span class="required">
	* </span></label>
	<div class="col-md-9">
	<div class="input-icon right">
		<i class="fa"></i>
		<input type="text" class="form-control" name="shopNumber"placeholder="نــمــبر دوکـــــان را بــنــویــســید">
	</div>
	</div>
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
	<label class="control-label col-md-3">مـوقـعـیت دوکان<span class="required">
	* </span></label>
	<div class="col-md-9">
	<div class="input-icon right">
		<i class="fa"></i>
		<input type="text" class="form-control" name="shopLocation" placeholder="مــوقــعـیت دوــکان را بــنــویــســید" />
	</div>
	</div>
	</div>
	</div>
	...
	* </span>
	...
	<div  class="col-md-6">
	<!-- BEGIN FORM-->
	<form action="#" id="shopRentPayment" class="form-horizontal">
	<div class="form-body">
	<div class="alert alert-danger display-hide">
	<button class="close" data-close="alert"></button>
	فــارم به صــورت درســت تـــکــمــیل نــگــردیده اســــــت.
	...
	* </span>
	...
	<div class="input-icon right">
	<i class="fa"></i>
	<input type="text" placeholder="کــرایــــه دوکــان" class="form-control" name="shopRent"/>
	</div>
	</div>
	</div>
	<div class="form-group">
	...
	* </span></label>
	...
	<div class="form-group">
	<label class="control-label col-md-4">نمبر دوکان<span class="required">
	* </span>
	</label>
	<div class="col-md-6">
	<div class="input-icon right">
	<i class="fa"></i>
	<input type="text" placeholder="کــــــــــرایــــــــــه دوکـــــان" readonly class="form-control" name="shopRent"/>
	</div>
	</div>
	</div>
	<div class="form-group">
	...
	* </span>
	...
	<div class="portlet-title">
	<div class="caption">
	<i ></i>پــــــــرداخـــــــــــــت مــصــرف بــرق دوکـــــان 
	</div>
	<div class="tools">
	<a href="javascript:;" class="collapse">
	</a>
	...
	* </span>
	...
	<div  class="col-md-6">
	<!-- BEGIN FORM-->
	<form action="#" id="shopElectricityPayment" class="form-horizontal">
	<div class="form-body">
	<div class="alert alert-danger display-hide">
	<button class="close" data-close="alert"></button>
	فــارم به صــورت درســت تـــکــمــیل نــگــردیده اســــــت.
	...
	* </span></label>
	...
	<div class="portlet-title">
	<div class="caption" >
	لــیــســت دوکــان هـایــــی کــــرایــــــه داده شـــــــــــــــــده
	</div>
	<div class="tools">
	...
	<div class="portlet-title">
	<div class="caption" >
	لــیــســت دوکــان هـایــــی فـــــروخــــتــه شـــــــــــــــــده
	</div>
	<div class="tools">
	<a class="close" data-dismiss="modal">
	</a>&nbsp
	...
	<div class="portlet-title">
	<div class="caption" >
	لــیــســت دوکــان هـایــــی خـــــــــالــــــــی
	</div>
	<div class="tools">
	<a class="close" data-dismiss="modal">
	</a>&nbsp
