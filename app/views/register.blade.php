      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" method="POST" action="{{URL::route('register-post') }}">
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" placeholder="اسم کاربر..." name="username" autofocus>
		            ...
		            @endif
		            <br>
		            <input name="password-again" type="password" class="form-control" placeholder="تکرار رمز ورود....">
		            @if($errors->has('password-again'))
		            <span style="color:red;">{{ $errors->first('password-again') }}</span>
		            @endif
		            <br>
		            ...
		            <button class="btn btn-theme btn-block" href="index.html" type="submit"><i class="fa fa-lock"></i><b> ایجا د</b></button>
